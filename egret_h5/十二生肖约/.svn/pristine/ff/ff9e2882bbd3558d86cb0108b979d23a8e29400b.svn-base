class UI_Rank_Dialog extends NTextDialog {
    ...
    public setText(text: string): UI_Rank_Dialog {
        this.text = text;
        return this;
    }
    ...
    public setClickListener(listener: Function, self: any, obj: any = null): UI_Rank_Dialog {
