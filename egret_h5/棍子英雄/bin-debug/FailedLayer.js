...
var FailedLayer = (function (_super) {
    ...
    var d = __define,c=FailedLayer;p=c.prototype;
    p.init = function () {
    ...
    //  分享按钮回调
    p.shareBtnCallback = function (evt) {
    ...
    //  重玩按钮回调
    p.restartBtnCallback = function (evt) {
        if (evt.type == egret.TouchEvent.TOUCH_BEGIN) {
            //console.log("touch begin");
            evt.currentTarget.scaleX = 1.05;
            evt.currentTarget.scaleY = 1.05;
    ...
    //  更多游戏按钮回调
    p.moreGameCallback = function (evt) {
        if (evt.type == egret.TouchEvent.TOUCH_BEGIN) {
            //console.log("touch begin");
            evt.currentTarget.scaleX = 1.05;
            evt.currentTarget.scaleY = 1.05;
...
egret.registerClass(FailedLayer,"FailedLayer");
