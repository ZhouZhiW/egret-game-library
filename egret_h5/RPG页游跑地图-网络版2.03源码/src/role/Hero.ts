...
class Hero extends egret.DisplayObjectContainer {
    ...
    private onPlayer(Group,j_name: string,p_name: string,z_name: string): void {
    ...
    private onGameFrame(e: egret.TimerEvent) {
        ...
        var ka: number = Math.abs(Ax - this.out_x);
        var kb: number = Math.abs(Ay - this.out_y);
        var kc: number = 2;
        if(ka < kc && kb < kc){
            this.GameFrame.stop();
            //..............................
