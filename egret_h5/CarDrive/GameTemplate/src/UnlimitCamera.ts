module d5power
{
    export class UnlimitCamera
    {
        ...
        public constructor(map:IMap) {
            if (UnlimitCamera._cameraView == null) UnlimitCamera._cameraView = new egret.Rectangle();
        ...
        public update():void {
            ...
            UnlimitCamera._cameraView.width = D5Game.screenWidth;
            UnlimitCamera._cameraView.height = D5Game.screenHeight;
        }
        ...
        public get cameraCutView():egret.Rectangle {
            var zero_x:number = UnlimitCamera.zeroX;
            var zero_y:number = UnlimitCamera.zeroY;
        ...
        public moveNorth(k:number = 1):void {
            if (this._moveSpeed == 0 || UnlimitCamera.zeroY == 0) return;
            this.focus = null;
        ...
        public moveWest(k:number = 1):void {
            if (this._moveSpeed == 0 || UnlimitCamera.zeroX == 0) return;
            this.focus = null;
        ...
        public flyTo(x:number, y:number, callback:Function = null):void {
            ...
            this._moveStart = new egret.Point(UnlimitCamera.zeroX - (D5Game.screenWidth >> 1), UnlimitCamera.zeroY - (D5Game.screenHeight >> 1));
