module d5power
{
    export class UnlimitMap implements IMap
    {
        /**
        ...
        private static rebuildPool(num:number):void
        {
            ...
            {
                while(UnlimitMap._tilePool.length>num) UnlimitMap._tilePool.pop();
            }else{
                while(UnlimitMap._tilePool.length<num) UnlimitMap._tilePool.push(new egret.Bitmap());
            }
        ...
        {
            if(UnlimitMap._tilePool.indexOf(data)==-1) UnlimitMap._tilePool.push(data);
        ...
        {
            if(container.contains(this._dbuffer)) return;
            if(this._dbuffer!=null)
            {
                ...
                if(this._loopBg) this._dbuffer.texture = this._loopBg;
        ...
        public render(flush:boolean = false):void {
            var zero_x:number = UnlimitCamera.zeroX % this._tileW;
            var zero_y:number = UnlimitCamera.zeroY % this._tileH;
        ...
        public getWorldPostion(x:number, y:number):egret.Point {
            this._tempPoint.x = UnlimitCamera.zeroX + x;
            this._tempPoint.y = UnlimitCamera.zeroY + y;
        ...
        public getScreenPostion(x:number, y:number):egret.Point {
            this._tempPoint.x = x - UnlimitCamera.zeroX;
            this._tempPoint.y = y - UnlimitCamera.zeroY;
            return this._tempPoint;
        }
