 ...
 *
 */
class PropertyScene extends egret.DisplayObjectContainer {
    ...
    private setbtn: egret.Bitmap;
    private aboutbtn: egret.Bitmap;
    private msgbtn: egret.Bitmap;
    private playerlayer: egret.Sprite;
    private bg1_x: number;
    private bg1_y: number;
    private npc = new Array(
        "npc0", "npc1");
    private npc_w = new Array(0, 230);
    ...
    private buylayer_a: egret.Sprite;
    private buylayer: egret.Sprite;
    private attribute_type: number;
    private npc_id: number;
    private prolist: Array<PropertyModeBean>;
    private shopimgSheet: egret.SpriteSheet;
    private proname: string = "";
    private meilinum: egret.BitmapText;
    private zhihuinum: egret.BitmapText;
    private koucainum: egret.BitmapText;
    private wulinum: egret.BitmapText;
    private npcnum: Array<egret.BitmapText> = new Array();
    private mta_itemid: number;
    ...
    private createScene() {
        ...
        this.bg1_x = 8;
        this.bg1_y = 50;
        var bg1_h: number = GameUtils.SCREEN_H - 140;
        ...
        var bg2_h: number = GameUtils.SCREEN_H - 380;
        ...
        var playername: egret.TextField = new egret.TextField();
        ...
        var playerid: egret.TextField = new egret.TextField();
        ...
        var property_s_x: number = 40;
        var property0_x: number = this.bg1_x + 110;
        var property0_y: number = this.bg1_y + 120 + iphone_top_y;
        ...
        for (var i: number = 0; i < 3; i++) {
            var add_btn: egret.Bitmap = new egret.Bitmap();
        ...
        for (var i: number = 0; i < GameUtils.playerBean.player_haogandu.length; i++) {
            ...
            var add_btn_0: egret.Bitmap = new egret.Bitmap();
        ...
        var bgsound: egret.Bitmap = new egret.Bitmap();
        ...
        var bgzhu: egret.Bitmap = new egret.Bitmap();
        ...
        var bgrectzhu: egret.Rectangle = new egret.Rectangle(34, 34, 34, 34);
        bgzhu.scale9Grid = bgrectzhu;
        bgzhu.width = GameUtils.SCREEN_W - (this.bg1_x + 10) * 2;
        bgzhu.height = 100;

        var btn_W: number = 35;
        var btn_x: number = (GameUtils.SCREEN_W - 76 * 4 - btn_W * 3) / 2;
        ...
        var kt: egret.Bitmap = new egret.Bitmap();
    ...
    private getItemId(index: number): void {
        ...
        for (var i: number = 0; i < GameUtils.propertyModeList.length; i++) {
            if (GameUtils.propertyModeList[i].propertym_attribute_type == this.attribute_type) {
                if (GameUtils.propertyModeList[i].propertym_attribute_type == 5) {
                    if (GameUtils.propertyModeList[i].propertym_npc_id == (this.npc_id + 1)) {
                        this.prolist.push(new PropertyModeBean(
                            GameUtils.propertyModeList[i].propertym_item_id,
                            GameUtils.propertyModeList[i].propertym_attribute_type,
                            GameUtils.propertyModeList[i].propertym_price,
                            GameUtils.propertyModeList[i].propertym_money_type,
                            GameUtils.propertyModeList[i].propertym_value,
                            GameUtils.propertyModeList[i].propertym_npc_id));
                    }
                } else {
                    this.prolist.push(new PropertyModeBean(
                        GameUtils.propertyModeList[i].propertym_item_id,
    ...
    private showBuyProperty(): void {
        ...
        for (var i: number = 0; i < 4; i++) {
            var buy_btn: egret.Bitmap = new egret.Bitmap();
            ...
            var value: egret.TextField = new egret.TextField();
            ...
            var buynum: egret.TextField = new egret.TextField();
        ...
        if (GameUtils.channelStr != "玩吧") {
            if (!GameUtils.noYaoQing) {
                var yaoqingbtn: egret.Bitmap = new egret.Bitmap();
            ...
            if (!GameUtils.isNewPlayerFourDay) {
                ...
                if (GameUtils.isShowRecallList) {
                    var huanxing: egret.Bitmap = new egret.Bitmap();
        ...
        var buyclose: egret.Bitmap = new egret.Bitmap();
    ...
    private buyProperty(evt: egret.TouchEvent) {
        var dianeff = new DianEff(this, evt.stageX, evt.stageY);
        if (GameUtils.gameSandPause) {
            return;
        }
    ...
    private getBuyComplete(event: egret.Event) {
    ...
    public gotoShop(evt: egret.TouchEvent): void {
        var dianeff = new DianEff(this, evt.stageX, evt.stageY);
        if (GameUtils.gameSandPause) {
            return;
        }
    ...
    private RefreshPropertyNum(): void {
        this.meilinum.text = "" + GameUtils.playerBean.player_meilizhi;
        this.zhihuinum.text = "" + GameUtils.playerBean.player_zhihui;
        this.koucainum.text = "" + GameUtils.playerBean.player_koucai;
        this.wulinum.text = "" + GameUtils.playerBean.player_wuli;
    ...
    private closeBuyProperty(evt: egret.TouchEvent) {
        var dianeff = new DianEff(this, evt.stageX, evt.stageY);
        if (GameUtils.gameSandPause) {
            return;
        }
    ...
    private addProperty(evt: egret.TouchEvent) {
        var dianeff = new DianEff(this, evt.stageX, evt.stageY);
        if (GameUtils.gameSandPause) {
            return;
        }
    ...
    private addHaogan(evt: egret.TouchEvent) {
        var dianeff = new DianEff(this, evt.stageX, evt.stageY);
        if (GameUtils.gameSandPause) {
            return;
        }
    ...
    private setBtn(evt: egret.TouchEvent) {
        var dianeff = new DianEff(this, evt.stageX, evt.stageY);
        if (GameUtils.gameSandPause) {
            return;
        }
    ...
    private aboutBtn(evt: egret.TouchEvent) {
        var dianeff = new DianEff(this, evt.stageX, evt.stageY);
        if (GameUtils.gameSandPause) {
            return;
        }
    ...
    private messageBtn(evt: egret.TouchEvent) {
        var dianeff = new DianEff(this, evt.stageX, evt.stageY);
        if (GameUtils.gameSandPause) {
            return;
        }
    ...
    private getMessageListComplete(event: egret.Event) {
        ...
        if (obj.notifications) {
            if (obj.notifications.length > 0) {
                ...
                for (var i: number = 0; i < obj.notifications.length; i++) {
    ...
    private showEnd(evt: egret.TouchEvent) {
        var dianeff = new DianEff(this, evt.stageX, evt.stageY);
        if (GameUtils.gameSandPause) {
            return;
        }
    ...
    private getOpenEndListComplete(event: egret.Event) {
        ...
        if (obj.result == 1) {
            ...
            var endScene: EndScene = new EndScene();
