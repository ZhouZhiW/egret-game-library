 ...
 *
 */
var DrawTopMoney = (function (_super) {
    __extends(DrawTopMoney, _super);
    function DrawTopMoney(gotoshopS, gotoshopC, gotoshopf, sceneObj) {
        var _this = _super.call(this) || this;
        _this.gotoshops = gotoshopS;
        _this.gotoshopc = gotoshopC;
        _this.thisobj = sceneObj;
        _this.gotoshopf = gotoshopf;
        _this.addEventListener(egret.Event.ADDED_TO_STAGE, _this.initstage, _this);
        return _this;
    }
    DrawTopMoney.prototype.initstage = function (event) {
        this.frameindex = 0;
    ...
    DrawTopMoney.prototype.onEnterFrame = function (e) {
        this.frameindex++;
    ...
    DrawTopMoney.prototype.closeMenoyFrame = function () {
        if (this.framespr) {
    ...
    DrawTopMoney.prototype.resetMoney = function () {
        if (this.toplayer) {
            this.toplayer.removeChildren();
        }
        this.createScene();
    };
    DrawTopMoney.prototype.createScene = function () {
        var topkuang = new egret.Bitmap();
        topkuang.texture = this.gameimgSheet.getTexture("moneytop");
        topkuang.x = 0;
        topkuang.y = 0;
        this.toplayer.addChild(topkuang);
        if (GameUtils.noDress) {
            var dressicon = new egret.Bitmap();
        ...
        if (GameUtils.isShowMiansiIcon || GameUtils.playerBean.player_miansi == 1) {
            ...
            var miansiicon = new egret.Bitmap();
        ...
        zuanshinumimg.y = 9;
        var zuanshiadd = new egret.Bitmap();
    ...
    DrawTopMoney.prototype.miansiBtn = function (evt) {
    ...
    DrawTopMoney.prototype.drawMianSi = function () {
    ...
    DrawTopMoney.prototype.yaoqing = function (evt) {
        var dianeff = new DianEff(this, evt.stageX, evt.stageY);
        if (GameUtils.gameSandPause) {
            return;
        }
    ...
    DrawTopMoney.prototype.getsharelistComplete = function (event) {
    ...
    DrawTopMoney.prototype.buyMiansi = function (evt) {
        var dianeff = new DianEff(this, evt.stageX, evt.stageY);
        if (GameUtils.gameSandPause) {
            return;
        }
    ...
    DrawTopMoney.prototype.onPostIOError = function (event) {
        NetWorkUtils.clearNetLoading();
    };
    DrawTopMoney.prototype.getPayGoodsComplete = function (event) {
    ...
    DrawTopMoney.prototype.dressBtn = function (evt) {
        var dianeff = new DianEff(this, evt.stageX, evt.stageY);
        if (GameUtils.gameSandPause) {
            return;
        }
    ...
    DrawTopMoney.prototype.helpBtn = function (evt) {
        var dianeff = new DianEff(this, evt.stageX, evt.stageY);
        if (GameUtils.gameSandPause) {
            return;
        }
    ...
    DrawTopMoney.prototype.drawHelp = function () {
        this.layer = new egret.Sprite;
        this.layer.graphics.beginFill(0x000000, 1);
        this.layer.graphics.drawRect(0, 0, GameUtils.SCREEN_W, GameUtils.SCREEN_H);
        this.layer.graphics.endFill();
        ...
        var closehelp = new egret.Bitmap();
    ...
    DrawTopMoney.prototype.closeHelp = function (evt) {
        var dianeff = new DianEff(this, evt.stageX, evt.stageY);
        if (GameUtils.gameSandPause) {
            return;
        }
...
__reflect(DrawTopMoney.prototype, "DrawTopMoney");
//# sourceMappingURL=DrawTopMoney.js.map