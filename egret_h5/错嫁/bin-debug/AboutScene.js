...
var AboutScene = (function (_super) {
    ...
    AboutScene.prototype.initstage = function (event) {
        this.gameimgSheet = RES.getRes("gameimg_json");
        this.coverimgSheet = RES.getRes("coverimg_json");
        this.createScene();
    };
    AboutScene.prototype.createScene = function () {
        ...
        var closeabout = new egret.Bitmap();
        ...
        var xiaoshuo_title = new egret.TextField();
        xiaoshuo_title.x = 0;
        ...
        var xiaoshuo = new egret.TextField();
        ...
        var msgkuang2 = new egret.Bitmap();
        ...
        var shouquan_title = new egret.TextField();
        shouquan_title.x = 0;
        ...
        var shouquan = new egret.TextField();
    ...
    AboutScene.prototype.closeAbout = function (evt) {
...
__reflect(AboutScene.prototype, "AboutScene");
