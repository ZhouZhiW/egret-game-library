...
declare const wx: {
     ...
     * 发起网络请求。
     */
    request(object: { url: string, data: string | Object, header: Object, method: string, dataType: string, success: (res: any, statusCode: number, header: Object) => void, fail: (res: any) => void, complete: (res: any) => void }): RequestTask;
    /**
    ...
    createOpenSettingButton(object: { type: string, text?: string, image?: string, style: any }): OpenSettingButton;
    /**
...
declare interface UpdateManager {
     ...
     * 监听更新包下载成功回调
     */
    onUpdateReady(callback: (res) => void): void;
    /**
     * 监听更新包下载失败回调
     */
    onUpdateFailed(callback: (res) => void): void;
}
