class gameGirllayer extends egret.DisplayObjectContainer {
    constructor(num) {
        super();
    ...
    private startLoad(): void {
        ...
        //音频资源放在resource文件夹下
        var url: string = "resource/music/"+(configData.gameLevel+1)+".mp3";
    ...
    private endHandler(evt: eui.UIEvent) {
        // console.log("end");
    ...
    private CreateBG(index, bgnum, _height) {
        ...
        var mc1: egret.MovieClip = new egret.MovieClip(mcFactory.generateMovieClipData("game"));
        mc1.play(-1);
        mc1.scaleX = 1.2;
        mc1.scaleY = 1.2;
        mc1.x = bgnum.x;
