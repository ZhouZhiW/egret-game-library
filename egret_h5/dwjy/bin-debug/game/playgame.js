...
var playgame = (function (_super) {
    ...
    function playgame() {
        ...
        _this.Allblack = []; /*用于存储所有数字对象*/
        _this.checkArr = []; /*用于存储要查找对象的四周相同元素的查询结果*/
        _this.speed = 150; /*物块的下落速度*/
        _this.getScore = 0;
        _this.IsClick = true; /*表示的当物块下落或者移动状态时，玩家是不容点击物块的*/
        /*添加血量*/
        _this.bloodArr = [];
        _this.bloodNum = 5;
        _this.removeNum = 0; /*表示的是删除的个数*/
        /*数字方块的掉落实现*/
        _this._isfirstFall = 0;
        _this.SpFallNum = 0;
        _this.overIdx = 0;
        _this.AntIdx = 0;
        _this.isOver = false;
        /*加载这个场景需要的的ui资源*/
        Data.playlayer = _this;
        Data.shareNum = 1;
        RES.addEventListener(RES.ResourceEvent.GROUP_COMPLETE, _this.onAddToStage, _this);
        RES.loadGroup("game");
        return _this;
    }
    playgame.prototype.onAddToStage = function () {
        /*加载位图数字文件*/
    ...
    /*添加背景*/
    playgame.prototype.addbg = function () {
    ...
    playgame.prototype.playBlood = function () {
    ...
    /*初始化地图配置*/
    playgame.prototype.initObj = function () {
        var num = 0;
    ...
    /*渲染配置好的显示对象*/
    playgame.prototype.addObj = function (tag, row, col, _x, _y) {
    ...
    /*渲染初始化血量*/
    playgame.prototype.createBlood = function (str, _x, _y) {
    ...
    /*血量更新*/
    playgame.prototype.RestBlood = function (_num) {
        this.bloodNum += _num;
        if (_num > 0) {
            if (this.bloodNum >= 5) {
                this.bloodNum = 5;
    ...
    /*点击显示对象的响应回调函数*/
    playgame.prototype.clickObj = function (evt, row) {
        if (this.IsClick) {
            /*当点击该方块时该方块上的数值加一*/
    ...
    playgame.prototype.getSameBlack = function (sp, Array) {
        if (sp.col + 1 < 5) {
    ...
    /*删除相同元素的数字方块*/
    playgame.prototype.removeSprite = function (removeArr) {
    ...
    playgame.prototype.spMove = function (sp, _x, _y, num, _removeArr) {
        var that = this;
        var time = this.speed;
    ...
    playgame.prototype.SpriteFall = function () {
        /*数字方块掉落 分两步处理
    ...
    playgame.prototype.SpriteAngineFall = function () {
        console.log("第二步");
    ...
    playgame.prototype.SpriteFallCheck = function () {
        var SameArr = [];
        var _Isbreak = false;
        for (var row = 0; row < 5; row++) {
            for (var col = 0; col < 5; col++) {
    ...
    playgame.prototype.ResetState = function (Array) {
        for (var a = 0; a < Array.length; a++) {
            Array[a].ischeck = true;
        }
        return Array;
    };
    playgame.prototype.Anmation = function (sp, row, _x, _y, time, num) {
    ...
    /*配置数字地图的算法*/
    playgame.prototype.getTag = function (row, col) {
        var numArr = [];
        var numArr1 = [];
        for (var i = 1; i < 7; i++) {
            numArr.push(i);
    ...
    /*获取数字方块的删除路径*/
    playgame.prototype.getNodeWays = function (startNode, endNode) {
        ...
        while (!findTheWay) {
            ...
            for (var i = 0; i < 4; i++) {
                ...
                else if (this.aStarthasObject(closeList, aroundNode)) {
                }
                else if (!this.aStarthasObject(openList, aroundNode)) {
                    aroundNode.parentNode = centerNode;
                    if (Math.abs(aroundNode.row - endNode.row) == 0 && Math.abs(aroundNode.col - endNode.col) == 0) {
                        findTheWay = true;
                        var pathArry = [];
    ...
    playgame.prototype.getAF = function (thisNode, endNode) {
    ...
    playgame.prototype.findMinNode = function (openListArr) {
    ...
    playgame.prototype.gettingAStarPath = function (laseNode, array) {
    ...
    /*数组增删的3个实例方法*/
    playgame.prototype.aStartIndexof = function (_Array, val) {
    ...
    playgame.prototype.aStartRemove = function (_Array, val) {
    ...
    playgame.prototype.aStarthasObject = function (_Array, val) {
        for (var a = 0; a < _Array.length; a++) {
            if (_Array[a].row == val.row && _Array[a].col == val.col) {
                return true;
            }
    ...
    /*  计算坐标x 和 y*/
    playgame.prototype.get_x = function (col) {
        return (col + 0.5) * (Data._width) + Data._w * (col + 1);
    };
    playgame.prototype.get_y = function (row) {
        return Data.start_y + (row + 0.5) * (Data._width) + (row + 1) * Data._w;
    };
    playgame.prototype.swapArr = function (Arr) {
        var swapArr = [];
    ...
    /*渲染玩家得分值*/
    playgame.prototype.onLoadComplete = function (font) {
    ...
    playgame.prototype.onLoadCompleteNum = function (font) {
        this._font = font;
    };
    /*重置玩家得分*/
    playgame.prototype.ResetScore = function (_score) {
        this.getScore += _score;
        this._score.text = this.getScore.toString();
        this._score.anchorOffsetX = this._score.width / 2;
        this._score.anchorOffsetY = this._score.height / 2;
    };
    playgame.prototype.overOrContinue = function () {
        if (Data.shareNum < 1) {
    ...
    playgame.prototype.endAmation = function () {
        var tagPush = [];
        this.tagArr = [];
        var tagArr1 = [];
        var tagArr2 = [
    ...
    playgame.prototype.overAmation = function (sp, num2) {
    ...
    playgame.prototype.getNextAnmation = function () {
    ...
    playgame.prototype.sortArr = function (m, n) {
